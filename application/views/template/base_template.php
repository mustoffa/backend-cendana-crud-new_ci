...
<link href="<?php echo base_url('assets') ?>/admin/jquery.dataTables.min.css" rel="stylesheet">
...
<script src="<?php echo base_url('assets') ?>/admin/jquery.dataTables.min.js"></script>
